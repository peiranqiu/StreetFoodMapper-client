                    ...
                    <div className="row">
                        <div class="col-sm-6 container user-register-form">
                            <div id="register" class="user-page-card">
                                <h1 class="display1">Are You a Truck?</h1>
                                <p class="subtitle">Sign up to create, customize and broadcast your custom truck profile on Food Truck Mapper.</p>
                        ...
                        <div className="col-sm-6"><img className="user-page-img" src={venderregister} alt="userlogin"/>
                        </div>
                    </div>
                </div>
